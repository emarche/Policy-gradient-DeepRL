"""Launch file for the discrete vanilla Advantage Actor Critic (A2C) with step by step updates, and the off-policy implementation with importance sampling.
...
from agent import AdvantageActorCritic
...
parser.add_argument('-offpolicy', type=bool, help='Off policy', default=cfg['agent']['off_policy'])
...
def main(params):
    ...
    agent = AdvantageActorCritic(env, cfg['agent'])
    tag = 'A2C_Discrete'
