"""Launch file for the discrete (dc) and continuous (cc) PPO algorithm with both MC updates
...
parser.add_argument('-std', type=float, help='Gauss noise σ', default=cfg['agent']['std'])
parser.add_argument('-std_scale', type=float, help='Scaling σ', default=cfg['agent']['std_scale'])
